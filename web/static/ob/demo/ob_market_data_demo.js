...
// QUARANTINED LEGACY MARKET FIXTURE
//
// DEMO / VISUAL / REHEARSAL USE ONLY.
//
// This file preserves the old market-sky fixture for development history.
// It MUST NOT be loaded by a normal/live Observatory surface.
// It MUST NOT be interpreted as current market truth.
//
// live_eligible = false
// =================================================================================================

window.OB_MARKET_DATA_DEMO_ONLY = true;
window.OB_MARKET_DATA_DEMO_LIVE_ELIGIBLE = false;

// OBSERVATORY_MARKET_MAP_V10_DATA_JS
window.OB_MARKET_DATA_DEMO = window.OB_MARKET_DATA_DEMO || {};

window.OB_MARKET_DATA_DEMO.sectors = [
  {
    name: "Technology",
