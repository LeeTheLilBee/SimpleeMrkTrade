...
from tower.tower_ir_cert_p2561 import tower_ir_cert_p2561


def test_tower_ir_cert_p2561_owner_beta_control_room():
    cert = tower_ir_cert_p2561()

    assert cert["pack"] == 2561
    assert cert["title"] == "Owner next-action command panel"
