...
from tower.tower_ir_cert_p2594 import tower_ir_cert_p2594


def test_tower_ir_cert_p2594_ob_real_surface_route_map():
    cert = tower_ir_cert_p2594()

    assert cert["pack"] == 2594
    assert cert["title"] == "Dashboard route mapping"
