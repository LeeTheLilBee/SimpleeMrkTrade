"""
Pack 2513 — Tower UI v2 Theme Contract.
"""
...
PACK_ID = "2513"
ENDPOINT = "/tower/ir-cert-v2513.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'Tower UI v2 Theme Contract',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "tower_ui_v2_theme_contract_ready": True,
        ...
        "contract": contract,
        "next_pack": "2514",
        "safe_to_continue_to_pack_2514": True,
    }

    return payload


def build_ir_cert_p2513_preview():
