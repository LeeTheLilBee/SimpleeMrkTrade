"""
Pack 2490 — Operations Release Evidence Packet.
"""
...
PACK_ID = "2490"
ENDPOINT = "/tower/ir-cert-v2490.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Operations Release Evidence Packet',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "release_evidence_packet_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2491",
        "safe_to_continue_to_pack_2491": True,
    }


def build_ir_cert_p2490_preview():
    return deepcopy(_build_cached())


def prepare_pack_2491_deployment_boundary():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2491",
