from tower.tower_ir_cert_p2524 import (
    build_ir_cert_p2524_preview,
)


def test_pack_2524_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2524_preview()

    assert payload["pack"] == "2524"
    assert payload["pack_name"] == 'Owner Approval Queue Surface'
    ...
    assert payload["owner_approval_queue_surface_ready"] is True
