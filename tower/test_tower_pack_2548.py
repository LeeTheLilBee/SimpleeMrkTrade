from tower.tower_ir_cert_p2548 import (
    build_ir_cert_p2548_preview,
)


def test_pack_2548_tower_ob_handoff_contract():
    payload = build_ir_cert_p2548_preview()

    assert payload["pack"] == "2548"
    assert payload["pack_name"] == 'Owner Session Preservation Receipt'
    ...
    assert payload["owner_session_preservation_receipt_ready"] is True
    assert payload[
