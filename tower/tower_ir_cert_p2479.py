"""
Pack 2479 — Owner Export Evidence Review.
"""
...
PACK_ID = "2479"
ENDPOINT = "/tower/ir-cert-v2479.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Owner Export Evidence Review',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "export_evidence_review_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2480",
        "safe_to_continue_to_pack_2480": True,
    }


def build_ir_cert_p2479_preview():
    return deepcopy(_build_cached())


def prepare_pack_2480_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2480",
