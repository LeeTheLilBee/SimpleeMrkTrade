...
from tower.tower_ir_cert_p2590 import tower_ir_cert_p2590


def test_tower_ir_cert_p2590_walkthrough_closeout():
    cert = tower_ir_cert_p2590()

    assert cert["pack"] == 2590
    assert cert["title"] == "Safety and no-live boundary receipt"
