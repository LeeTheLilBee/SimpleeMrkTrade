...
from tower.tower_ir_cert_p2562 import tower_ir_cert_p2562


def test_tower_ir_cert_p2562_owner_beta_control_room():
    cert = tower_ir_cert_p2562()

    assert cert["pack"] == 2562
    assert cert["title"] == "Safety certs and route/API integration"
