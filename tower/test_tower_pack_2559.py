...
from tower.tower_ir_cert_p2559 import tower_ir_cert_p2559


def test_tower_ir_cert_p2559_owner_beta_control_room():
    cert = tower_ir_cert_p2559()

    assert cert["pack"] == 2559
    assert cert["title"] == "OB beta gate summary"
