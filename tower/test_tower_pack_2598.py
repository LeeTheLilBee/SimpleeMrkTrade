...
from tower.tower_ir_cert_p2598 import tower_ir_cert_p2598


def test_tower_ir_cert_p2598_ob_real_surface_route_map():
    cert = tower_ir_cert_p2598()

    assert cert["pack"] == 2598
    assert cert["title"] == "Review Center route mapping"
