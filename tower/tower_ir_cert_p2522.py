"""
Pack 2522 — Simplee Front Door Checkpoint.
"""
...
PACK_ID = "2522"
ENDPOINT = "/tower/ir-cert-v2522.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'Simplee Front Door Checkpoint',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "simplee_front_door_checkpoint_ready": True,
        ...
        "contract": contract,
        "next_pack": "2523",
        "safe_to_continue_to_pack_2523": True,
    }

    return payload


def build_ir_cert_p2522_preview():
