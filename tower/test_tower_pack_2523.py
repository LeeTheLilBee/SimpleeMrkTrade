from tower.tower_ir_cert_p2523 import (
    build_ir_cert_p2523_preview,
)


def test_pack_2523_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2523_preview()

    assert payload["pack"] == "2523"
    assert payload["pack_name"] == 'Owner Console Route Shell'
    ...
    assert payload["owner_console_route_shell_ready"] is True
