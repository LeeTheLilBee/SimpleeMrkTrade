...
from tower.tower_ir_cert_p2592 import tower_ir_cert_p2592


def test_tower_ir_cert_p2592_walkthrough_closeout():
    cert = tower_ir_cert_p2592()

    assert cert["pack"] == 2592
    assert cert["title"] == "Route and API integration cert"
