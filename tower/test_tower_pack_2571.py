...
from tower.tower_ir_cert_p2571 import tower_ir_cert_p2571


def test_tower_ir_cert_p2571_owner_beta_route_gate():
    cert = tower_ir_cert_p2571()

    assert cert["pack"] == 2571
    assert cert["title"] == "Route integration tests"
