from tower.tower_ir_cert_p2529 import (
    build_ir_cert_p2529_preview,
)


def test_pack_2529_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2529_preview()

    assert payload["pack"] == "2529"
    assert payload["pack_name"] == 'Deployment / Activation Hold Panel'
    ...
    assert payload["deployment_activation_hold_panel_ready"] is True
