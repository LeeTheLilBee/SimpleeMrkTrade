"""
Pack 2484 — Environment Binding Receipt.
"""
...
PACK_ID = "2484"
ENDPOINT = "/tower/ir-cert-v2484.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Environment Binding Receipt',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "environment_binding_receipt_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2485",
        "safe_to_continue_to_pack_2485": True,
    }


def build_ir_cert_p2484_preview():
    return deepcopy(_build_cached())


def prepare_pack_2485_deployment_boundary():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2485",
