...
def test_pack_2437_real_surface_contract():
    payload = build_ir_cert_p2437_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["market_map_real_surface_ready"] is True
