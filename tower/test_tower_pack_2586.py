...
from tower.tower_ir_cert_p2586 import tower_ir_cert_p2586


def test_tower_ir_cert_p2586_walkthrough_closeout():
    cert = tower_ir_cert_p2586()

    assert cert["pack"] == 2586
    assert cert["title"] == "Issue intake receipt summary"
