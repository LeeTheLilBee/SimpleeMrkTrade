"""
Pack 2482 — Hosted Persistence Assurance Checkpoint.
"""
...
PACK_ID = "2482"
ENDPOINT = "/tower/ir-cert-v2482.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Hosted Persistence Assurance Checkpoint',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "hosted_assurance_checkpoint_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2483",
        "safe_to_continue_to_pack_2483": True,
    }


def build_ir_cert_p2482_preview():
    return deepcopy(_build_cached())


def prepare_pack_2483_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2483",
