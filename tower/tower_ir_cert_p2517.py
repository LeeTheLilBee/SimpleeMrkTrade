"""
Pack 2517 — OB Return Session Continuity.
"""
...
PACK_ID = "2517"
ENDPOINT = "/tower/ir-cert-v2517.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'OB Return Session Continuity',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "ob_return_session_continuity_ready": True,
        ...
        "contract": contract,
        "next_pack": "2518",
        "safe_to_continue_to_pack_2518": True,
    }

    return payload


def build_ir_cert_p2517_preview():
