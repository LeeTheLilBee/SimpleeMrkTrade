...
from tower.tower_ir_cert_p2555 import tower_ir_cert_p2555


def test_tower_ir_cert_p2555_owner_beta_control_room():
    cert = tower_ir_cert_p2555()

    assert cert["pack"] == 2555
    assert cert["title"] == "Walkthrough receipt viewer"
