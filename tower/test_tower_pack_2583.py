...
from tower.tower_ir_cert_p2583 import tower_ir_cert_p2583


def test_tower_ir_cert_p2583_walkthrough_closeout():
    cert = tower_ir_cert_p2583()

    assert cert["pack"] == 2583
    assert cert["title"] == "Walkthrough closeout contract"
