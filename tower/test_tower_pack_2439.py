...
def test_pack_2439_real_surface_contract():
    payload = build_ir_cert_p2439_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["trade_center_real_surface_ready"] is True
