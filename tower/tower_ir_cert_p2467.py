...
PACK_ID = "2467"
ENDPOINT = "/tower/ir-cert-v2467.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        ...
        "preview_only": True,
        "next_pack": "2468",
        "safe_to_continue_to_pack_2468": True,
    }


def build_ir_cert_p2467_preview():
    return deepcopy(_build_cached())


def prepare_pack_2468_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2468",
