"""
SEARCHABLE LABEL:
TOWER_PACK_2013_OWNER_DECISION_EXECUTION_READINESS_INDEX
"""
...
PACK_NAME = (
    ...
    "Execution Readiness Index Preview"
)
ENDPOINT = "/tower/beta-incident-response-owner-decision-execution-readiness-index-v2013.json"
...
TOWER_SUBLAYER = (
    "Owner Decision Execution Readiness Index"
)
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": f"pack_2013_category_{index:03d}",
    ...
    for index, item in enumerate(
        ...
        rows.append({
            "row_id": f"pack_2013_item_{index:03d}",
    ...
    for index, action in enumerate(
        ...
        rows.append({
            "row_id": f"pack_2013_blocked_{index:03d}",
    ...
    return {
        ...
        "preview_only": True,
        "contract_only": True,
        "execution_readiness_rows": rows,
        "tower_pack_2013_summary": summary,
        "safe_to_continue_to_pack_2014": ready,
    }
...
def build_pack_2013_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_2014": payload[
            "safe_to_continue_to_pack_2014"
        ],
    }


def prepare_pack_2014_tower_beta_incident_response_owner_decision_execution_readiness_index():
    return {
        "ready": True,
        "next_pack": "2014",
        "source_pack": "2013",
