...
from tower.tower_ir_cert_p2579 import tower_ir_cert_p2579


def test_tower_ir_cert_p2579_issue_intake():
    cert = tower_ir_cert_p2579()

    assert cert["pack"] == 2579
    assert cert["title"] == "Soulaana interpretation note field"
