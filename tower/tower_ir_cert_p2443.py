"""
Pack 2443 — Guided Run Progress Contract.
"""
...
PACK_ID = "2443"
ENDPOINT = "/tower/ir-cert-v2443.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Guided Run Progress Contract',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "guided_run_progress_ready": True,
        "guided_run_route": (
        ...
        "writes_state": False,
        "next_pack": "2444",
        "safe_to_continue_to_pack_2444": True,
    }


def build_ir_cert_p2443_preview():
    return deepcopy(_build_cached())


def prepare_pack_2444_guided_ob_run():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2444",
