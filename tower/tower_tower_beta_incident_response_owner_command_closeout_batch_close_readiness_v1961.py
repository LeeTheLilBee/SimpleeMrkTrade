"""
SEARCHABLE LABEL:
TOWER_PACK_1961_TOWER_BETA_INCIDENT_RESPONSE_OWNER_COMMAND_CLOSEOUT_BATCH_CLOSE_READINESS
"""
...
PACK_ID = "1961"
PACK_NUMBER = 1961
PACK_NAME = "Tower Beta Incident Response Owner Command Closeout Batch Close Readiness Preview"
ENDPOINT = "/tower/beta-incident-response-owner-command-giant-closeout-v1961.json"
...
def _source_payload():
    return deepcopy({'pack': '1960', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-command-closeout-readiness-bridge-v1960.json', 'safe_to_continue_to_pack_1961': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_command_closeout_batch_close_readiness_"
                "1961_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_1961") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_command_closeout_batch_close_readiness_ready": ready,
    ...
    return {
        ...
        "tower_beta_incident_response_owner_command_closeout_batch_close_readiness_summary": summary,
        "safe_to_continue_to_pack_1962": ready,
    }


def build_tower_beta_incident_response_owner_command_closeout_batch_close_readiness_preview():
    return deepcopy(_build_cached())


def build_pack_1961_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_1962": payload[
            "safe_to_continue_to_pack_1962"
        ],
    }


def prepare_pack_1962_tower_beta_incident_response_owner_decision_index():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Decision Index Preview",
        "source_pack": PACK_ID,
