from tower.tower_ir_cert_p2552 import (
    build_ir_cert_p2552_preview,
)


def test_pack_2552_tower_ob_handoff_contract():
    payload = build_ir_cert_p2552_preview()
    ...
    assert payload["tower_ob_handoff_repair_checkpoint_ready"] is True
    assert payload[
