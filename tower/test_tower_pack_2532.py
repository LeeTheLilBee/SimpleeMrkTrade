from tower.tower_ir_cert_p2532 import (
    build_ir_cert_p2532_preview,
)


def test_pack_2532_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2532_preview()
