from tower.tower_ir_cert_p2533 import (
    build_ir_cert_p2533_preview,
)


def test_pack_2533_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2533_preview()

    assert payload["pack"] == "2533"
    assert payload["pack_name"] == 'Ecosystem Door Registry Contract'
    ...
    assert payload["ecosystem_door_registry_contract_ready"] is True
