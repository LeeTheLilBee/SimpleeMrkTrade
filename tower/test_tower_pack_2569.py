...
from tower.tower_ir_cert_p2569 import tower_ir_cert_p2569


def test_tower_ir_cert_p2569_owner_beta_route_gate():
    cert = tower_ir_cert_p2569()

    assert cert["pack"] == 2569
    assert cert["title"] == "Dangerous-controls lock preservation"
