...
from tower.tower_ir_cert_p2553 import tower_ir_cert_p2553


def test_tower_ir_cert_p2553_owner_beta_control_room():
    cert = tower_ir_cert_p2553()

    assert cert["pack"] == 2553
    assert cert["title"] == "Owner Beta Dashboard contract"
