...
from tower.tower_ir_cert_p2566 import tower_ir_cert_p2566


def test_tower_ir_cert_p2566_owner_beta_route_gate():
    cert = tower_ir_cert_p2566()

    assert cert["pack"] == 2566
    assert cert["title"] == "Owner-session allowed HTML route"
