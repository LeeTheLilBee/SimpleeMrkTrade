...
PACK_ID = "2519"
ENDPOINT = "/tower/ir-cert-v2519.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'Owner Actions Panel',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "owner_actions_panel_ready": True,
        ...
        "contract": contract,
        "next_pack": "2520",
        "safe_to_continue_to_pack_2520": True,
    }

    return payload


def build_ir_cert_p2519_preview():
