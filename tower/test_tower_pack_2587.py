...
from tower.tower_ir_cert_p2587 import tower_ir_cert_p2587


def test_tower_ir_cert_p2587_walkthrough_closeout():
    cert = tower_ir_cert_p2587()

    assert cert["pack"] == 2587
    assert cert["title"] == "Tester entry readiness gate"
