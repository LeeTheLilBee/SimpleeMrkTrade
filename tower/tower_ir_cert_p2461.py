"""
Pack 2461 — Ledger Integrity Verification.
"""
...
PACK_ID = "2461"
ENDPOINT = "/tower/ir-cert-v2461.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Ledger Integrity Verification',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        ...
        "contract_only": True,
        "next_pack": "2462",
        "safe_to_continue_to_pack_2462": True,
    }


def build_ir_cert_p2461_preview():
    return deepcopy(_build_cached())


def prepare_pack_2462_guided_run_persistence():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2462",
