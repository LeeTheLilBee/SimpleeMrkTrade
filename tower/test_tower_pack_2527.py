from tower.tower_ir_cert_p2527 import (
    build_ir_cert_p2527_preview,
)


def test_pack_2527_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2527_preview()

    assert payload["pack"] == "2527"
    assert payload["pack_name"] == 'App Permission Overview'
    ...
    assert payload["app_permission_overview_ready"] is True
