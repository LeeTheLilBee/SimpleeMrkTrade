...
from tower.tower_ir_cert_p2556 import tower_ir_cert_p2556


def test_tower_ir_cert_p2556_owner_beta_control_room():
    cert = tower_ir_cert_p2556()

    assert cert["pack"] == 2556
    assert cert["title"] == "Owner issue intake"
