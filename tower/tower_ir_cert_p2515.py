"""
Pack 2515 — Simplee App Launch Cards.
"""
...
PACK_ID = "2515"
ENDPOINT = "/tower/ir-cert-v2515.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'Simplee App Launch Cards',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "simplee_app_launch_cards_ready": True,
        ...
        "contract": contract,
        "next_pack": "2516",
        "safe_to_continue_to_pack_2516": True,
    }

    return payload


def build_ir_cert_p2515_preview():
