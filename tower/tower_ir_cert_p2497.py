"""
Pack 2497 — Activation Window Preview.
"""
...
PACK_ID = "2497"
ENDPOINT = "/tower/ir-cert-v2497.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Activation Window Preview',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "activation_window_preview_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2498",
        "safe_to_continue_to_pack_2498": True,
    }


def build_ir_cert_p2497_preview():
    return deepcopy(_build_cached())


def prepare_pack_2498_activation_approval():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2498",
