"""
Pack 2502 — Owner Approval Readiness Checkpoint.
"""
...
PACK_ID = "2502"
ENDPOINT = "/tower/ir-cert-v2502.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Owner Approval Readiness Checkpoint',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "owner_approval_checkpoint_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2503",
        "safe_to_continue_to_pack_2503": True,
    }


def build_ir_cert_p2502_preview():
    return deepcopy(_build_cached())


def prepare_pack_2503_activation_approval():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2503",
