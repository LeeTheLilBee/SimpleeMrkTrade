"""
Pack 2437 — Market Map Real-Surface Walkthrough Integration.
"""
...
PACK_ID = "2437"
ENDPOINT = "/tower/ir-cert-v2437.json"
TARGET_ROOM_ID = 'ob_room_market_map'
...
def _build_cached() -> Dict[str, Any]:
    ...
    return {
        "pack": PACK_ID,
        "pack_name": 'Market Map Real-Surface Walkthrough Integration',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "market_map_real_surface_ready": True,
        ...
        "writes_state": False,
        "next_pack": "2438",
        "safe_to_continue_to_pack_2438": True,
    }


def build_ir_cert_p2437_preview():
    return deepcopy(_build_cached())


def prepare_pack_2438_ob_real_surface():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2438",
