...
from tower.tower_ir_cert_p2554 import tower_ir_cert_p2554


def test_tower_ir_cert_p2554_owner_beta_control_room():
    cert = tower_ir_cert_p2554()

    assert cert["pack"] == 2554
    assert cert["title"] == "Hosted staging readiness card"
