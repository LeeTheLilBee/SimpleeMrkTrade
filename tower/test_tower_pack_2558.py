...
from tower.tower_ir_cert_p2558 import tower_ir_cert_p2558


def test_tower_ir_cert_p2558_owner_beta_control_room():
    cert = tower_ir_cert_p2558()

    assert cert["pack"] == 2558
    assert cert["title"] == "App readiness matrix"
