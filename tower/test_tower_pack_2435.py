...
def test_pack_2435_real_surface_contract():
    payload = build_ir_cert_p2435_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["protected_preview_context_ready"] is True
