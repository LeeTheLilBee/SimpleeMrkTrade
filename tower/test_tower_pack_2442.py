...
def test_pack_2442_real_surface_contract():
    payload = build_ir_cert_p2442_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["six_room_real_surface_ready"] is True
