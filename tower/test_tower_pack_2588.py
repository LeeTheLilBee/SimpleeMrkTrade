...
from tower.tower_ir_cert_p2588 import tower_ir_cert_p2588


def test_tower_ir_cert_p2588_walkthrough_closeout():
    cert = tower_ir_cert_p2588()

    assert cert["pack"] == 2588
    assert cert["title"] == "Tester invite prep record"
