...
from tower.tower_ir_cert_p2575 import tower_ir_cert_p2575


def test_tower_ir_cert_p2575_issue_intake():
    cert = tower_ir_cert_p2575()

    assert cert["pack"] == 2575
    assert cert["title"] == "Local JSONL append-only beta issue store"
