"""
Pack 2475 — Backup Cadence Readiness.
"""
...
PACK_ID = "2475"
ENDPOINT = "/tower/ir-cert-v2475.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Backup Cadence Readiness',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "backup_cadence_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2476",
        "safe_to_continue_to_pack_2476": True,
    }


def build_ir_cert_p2475_preview():
    return deepcopy(_build_cached())


def prepare_pack_2476_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2476",
