"""
Pack 2499 — Deployment Command Dry Run.
"""
...
PACK_ID = "2499"
ENDPOINT = "/tower/ir-cert-v2499.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Deployment Command Dry Run',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "deployment_command_dry_run_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2500",
        "safe_to_continue_to_pack_2500": True,
    }


def build_ir_cert_p2499_preview():
    return deepcopy(_build_cached())


def prepare_pack_2500_activation_approval():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2500",
