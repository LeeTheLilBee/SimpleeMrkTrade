...
from tower.tower_ir_cert_p2601 import tower_ir_cert_p2601


def test_tower_ir_cert_p2601_ob_real_surface_route_map():
    cert = tower_ir_cert_p2601()

    assert cert["pack"] == 2601
    assert cert["title"] == "Tower handoff/session boundary preservation"
