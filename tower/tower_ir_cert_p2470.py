"""
Pack 2470 — Owner Export Preview.
"""
...
PACK_ID = "2470"
ENDPOINT = "/tower/ir-cert-v2470.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Owner Export Preview',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "owner_export_preview_ready": True,
        "backup_directory_environment_key": (
            BACKUP_DIRECTORY_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2471",
        "safe_to_continue_to_pack_2471": True,
    }


def build_ir_cert_p2470_preview():
    return deepcopy(_build_cached())


def prepare_pack_2471_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2471",
