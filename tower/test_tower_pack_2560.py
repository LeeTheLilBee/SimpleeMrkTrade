...
from tower.tower_ir_cert_p2560 import tower_ir_cert_p2560


def test_tower_ir_cert_p2560_owner_beta_control_room():
    cert = tower_ir_cert_p2560()

    assert cert["pack"] == 2560
    assert cert["title"] == "Tester access status surface"
