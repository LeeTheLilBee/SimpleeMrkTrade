"""
SEARCHABLE LABEL:
TOWER_PACK_1987_TOWER_BETA_INCIDENT_RESPONSE_OWNER_DECISION_BLOCKER_REVIEW_OWNER_SUMMARY
...
PACK_ID = "1987"
PACK_NUMBER = 1987
PACK_NAME = "Tower Beta Incident Response Owner Decision Blocker Review Owner Summary Preview"
ENDPOINT = "/tower/tower-beta-incident-response-owner-decision-blocker-review-owner-summary-v1987.json"
...
def _source_payload():
    return deepcopy({'pack': '1986', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-decision-blocker-review-detail-drawer-v1986.json', 'safe_to_continue_to_pack_1987': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_decision_blocker_review_owner_summary_"
                "1987_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_1987") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_decision_blocker_review_owner_summary_ready": ready,
    ...
    return {
        ...
        "tower_beta_incident_response_owner_decision_blocker_review_owner_summary_summary": summary,
        "safe_to_continue_to_pack_1988": ready,
    }


def build_tower_beta_incident_response_owner_decision_blocker_review_owner_summary_preview():
    return deepcopy(_build_cached())


def build_pack_1987_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_1988": payload[
            "safe_to_continue_to_pack_1988"
        ],
    }


def prepare_pack_1988_tower_beta_incident_response_owner_decision_blocker_review_note_draft():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Decision Blocker Review Note Draft Preview",
        "source_pack": PACK_ID,
