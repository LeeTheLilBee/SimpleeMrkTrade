...
from tower.tower_ir_cert_p2577 import tower_ir_cert_p2577


def test_tower_ir_cert_p2577_issue_intake():
    cert = tower_ir_cert_p2577()

    assert cert["pack"] == 2577
    assert cert["title"] == "Review receipt generation"
