from tower.tower_ir_cert_p2538 import (
    build_ir_cert_p2538_preview,
)


def test_pack_2538_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2538_preview()

    assert payload["pack"] == "2538"
    assert payload["pack_name"] == 'Door Owner-Control Linkage'
    ...
    assert payload["door_owner_control_linkage_ready"] is True
