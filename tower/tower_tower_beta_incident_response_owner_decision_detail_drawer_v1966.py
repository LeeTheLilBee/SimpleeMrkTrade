"""
SEARCHABLE LABEL:
TOWER_PACK_1966_TOWER_BETA_INCIDENT_RESPONSE_OWNER_DECISION_DETAIL_DRAWER
...
PACK_ID = "1966"
PACK_NUMBER = 1966
PACK_NAME = "Tower Beta Incident Response Owner Decision Detail Drawer Preview"
ENDPOINT = "/tower/tower-beta-incident-response-owner-decision-detail-drawer-v1966.json"
...
def _source_payload():
    return deepcopy({'pack': '1965', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-decision-decision-matrix-v1965.json', 'safe_to_continue_to_pack_1966': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_decision_detail_drawer_"
                "1966_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_1966") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_decision_detail_drawer_ready": ready,
    ...
    return {
        ...
        "tower_beta_incident_response_owner_decision_detail_drawer_summary": summary,
        "safe_to_continue_to_pack_1967": ready,
    }


def build_tower_beta_incident_response_owner_decision_detail_drawer_preview():
    return deepcopy(_build_cached())


def build_pack_1966_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_1967": payload[
            "safe_to_continue_to_pack_1967"
        ],
    }


def prepare_pack_1967_tower_beta_incident_response_owner_decision_owner_summary():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Decision Owner Summary Preview",
        "source_pack": PACK_ID,
