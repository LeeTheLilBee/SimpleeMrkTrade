"""
Pack 2453 — Walkthrough Persistence Boundary.
"""
...
PACK_ID = "2453"
ENDPOINT = "/tower/ir-cert-v2453.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Walkthrough Persistence Boundary',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "persistence_boundary_ready": True,
        "database_environment_key": (
            DATABASE_ENVIRONMENT_KEY
        ),
        ...
        "contract_only": True,
        "next_pack": "2454",
        "safe_to_continue_to_pack_2454": True,
    }


def build_ir_cert_p2453_preview():
    return deepcopy(_build_cached())


def prepare_pack_2454_guided_run_persistence():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2454",
