"""
SEARCHABLE LABEL:
TOWER_PACK_2017_TOWER_BETA_INCIDENT_RESPONSE_OWNER_DECISION_EXECUTION_READINESS_DETAIL_DRAWER
"""
...
PACK_ID = "2017"
PACK_NUMBER = 2017
PACK_NAME = "Tower Beta Incident Response Owner Decision Execution Readiness Detail Drawer Preview"
ENDPOINT = "/tower/tower-beta-incident-response-owner-decision-execution-readiness-detail-drawer-v2017.json"
...
def _source_payload():
    return deepcopy({'pack': '2016', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-decision-execution-readiness-execution-matrix-v2016.json', 'safe_to_continue_to_pack_2017': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_decision_execution_readiness_detail_drawer_"
                "2017_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_2017") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_decision_execution_readiness_detail_drawer_ready": ready,
    ...
    return {
        ...
        "tower_beta_incident_response_owner_decision_execution_readiness_detail_drawer_summary": summary,
        "safe_to_continue_to_pack_2018": ready,
    }


def build_tower_beta_incident_response_owner_decision_execution_readiness_detail_drawer_preview():
    return deepcopy(_build_cached())


def build_pack_2017_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_2018": payload[
            "safe_to_continue_to_pack_2018"
        ],
    }


def prepare_pack_2018_tower_beta_incident_response_owner_decision_execution_readiness_owner_summary():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Decision Execution Readiness Owner Summary Preview",
        "source_pack": PACK_ID,
