...
from tower.tower_ir_cert_p2578 import tower_ir_cert_p2578


def test_tower_ir_cert_p2578_issue_intake():
    cert = tower_ir_cert_p2578()

    assert cert["pack"] == 2578
    assert cert["title"] == "Beta blocker receipt linkage"
