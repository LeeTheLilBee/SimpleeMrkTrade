"""
Pack 2436 — Dashboard Real-Surface Walkthrough Integration.
"""
...
PACK_ID = "2436"
ENDPOINT = "/tower/ir-cert-v2436.json"
TARGET_ROOM_ID = 'ob_room_dashboard'
...
def _build_cached() -> Dict[str, Any]:
    ...
    return {
        "pack": PACK_ID,
        "pack_name": 'Dashboard Real-Surface Walkthrough Integration',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "dashboard_real_surface_ready": True,
        ...
        "writes_state": False,
        "next_pack": "2437",
        "safe_to_continue_to_pack_2437": True,
    }


def build_ir_cert_p2436_preview():
    return deepcopy(_build_cached())


def prepare_pack_2437_ob_real_surface():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2437",
