...
def test_pack_2441_real_surface_contract():
    payload = build_ir_cert_p2441_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["owner_console_real_surface_ready"] is True
