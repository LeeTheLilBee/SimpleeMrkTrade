from tower.tower_ir_cert_p2525 import (
    build_ir_cert_p2525_preview,
)


def test_pack_2525_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2525_preview()

    assert payload["pack"] == "2525"
    assert payload["pack_name"] == 'Dangerous Action Review Cards'
    ...
    assert payload["dangerous_action_review_cards_ready"] is True
