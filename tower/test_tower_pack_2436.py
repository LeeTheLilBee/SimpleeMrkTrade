...
def test_pack_2436_real_surface_contract():
    payload = build_ir_cert_p2436_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["dashboard_real_surface_ready"] is True
