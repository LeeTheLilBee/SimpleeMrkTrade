"""
SEARCHABLE LABEL:
TOWER_PACK_1960_TOWER_BETA_INCIDENT_RESPONSE_OWNER_COMMAND_CLOSEOUT_READINESS_BRIDGE
"""
...
PACK_ID = "1960"
PACK_NUMBER = 1960
PACK_NAME = "Tower Beta Incident Response Owner Command Closeout Readiness Bridge Preview"
ENDPOINT = "/tower/tower-beta-incident-response-owner-command-closeout-readiness-bridge-v1960.json"
...
TOWER_SUBLAYER = "Incident Response Owner Command Giant Closeout"
...
def _source_payload():
    return deepcopy({'pack': '1959', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-command-closeout-handoff-contract-v1959.json', 'safe_to_continue_to_pack_1960': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_command_closeout_readiness_bridge_"
                "1960_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_1960") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_command_closeout_readiness_bridge_ready": ready,
    ...
    return {
        ...
        "source_safe_to_continue": source.get(
            "safe_to_continue_to_pack_1960"
        ),
        "tower_beta_incident_response_owner_command_closeout_readiness_bridge_summary": summary,
        "safe_to_continue_to_pack_1961": ready,
    }


def build_tower_beta_incident_response_owner_command_closeout_readiness_bridge_preview():
    return deepcopy(_build_cached())


def build_pack_1960_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_1961": payload[
            "safe_to_continue_to_pack_1961"
        ],
    }


def prepare_pack_1961_tower_beta_incident_response_owner_command_closeout_batch_close_readiness():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Command Closeout Batch Close Readiness Preview",
        "source_pack": PACK_ID,
