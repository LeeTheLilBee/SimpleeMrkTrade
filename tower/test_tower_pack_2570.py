...
from tower.tower_ir_cert_p2570 import tower_ir_cert_p2570


def test_tower_ir_cert_p2570_owner_beta_route_gate():
    cert = tower_ir_cert_p2570()

    assert cert["pack"] == 2570
    assert cert["title"] == "Hosted owner-beta boundary cert"
