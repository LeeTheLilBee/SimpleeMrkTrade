"""
Pack 2441 — Owner Console Real-Surface Walkthrough Integration.
"""
...
PACK_ID = "2441"
ENDPOINT = "/tower/ir-cert-v2441.json"
TARGET_ROOM_ID = 'ob_room_owner_console'
...
def _build_cached() -> Dict[str, Any]:
    ...
    return {
        "pack": PACK_ID,
        "pack_name": 'Owner Console Real-Surface Walkthrough Integration',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "owner_console_real_surface_ready": True,
        ...
        "writes_state": False,
        "next_pack": "2442",
        "safe_to_continue_to_pack_2442": True,
    }


def build_ir_cert_p2441_preview():
    return deepcopy(_build_cached())


def prepare_pack_2442_ob_real_surface():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2442",
