"""
Pack 2428 — Walkthrough Receipt View
"""
...
PACK_ID = "2428"
ENDPOINT = "/tower/ir-cert-v2428.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": "Walkthrough Receipt View",
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "receipt_view_ready": True,
        "walkthrough_route": (
        ...
        "writes_state": False,
        "next_pack": "2429",
        "safe_to_continue_to_pack_2429": True,
    }


def build_ir_cert_p2428_preview() -> Dict[str, Any]:
    return deepcopy(_build_cached())


def prepare_pack_2429_ob_walkthrough() -> Dict[str, Any]:
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2429",
        "name": "Guided Close and Lockback",
        "walkthrough_route": (
            "/tower/observatory-walkthrough"
        ),
        "default_deny": True,
