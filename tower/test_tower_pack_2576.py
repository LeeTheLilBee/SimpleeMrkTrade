...
from tower.tower_ir_cert_p2576 import tower_ir_cert_p2576


def test_tower_ir_cert_p2576_issue_intake():
    cert = tower_ir_cert_p2576()

    assert cert["pack"] == 2576
    assert cert["title"] == "Issue list/read model"
