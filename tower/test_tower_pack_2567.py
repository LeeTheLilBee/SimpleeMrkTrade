...
from tower.tower_ir_cert_p2567 import tower_ir_cert_p2567


def test_tower_ir_cert_p2567_owner_beta_route_gate():
    cert = tower_ir_cert_p2567()

    assert cert["pack"] == 2567
    assert cert["title"] == "Owner-session allowed JSON route"
