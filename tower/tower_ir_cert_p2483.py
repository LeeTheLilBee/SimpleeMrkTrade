"""
Pack 2483 — Hosted Deployment Manifest.
"""
...
PACK_ID = "2483"
ENDPOINT = "/tower/ir-cert-v2483.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Hosted Deployment Manifest',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "deployment_manifest_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2484",
        "safe_to_continue_to_pack_2484": True,
    }


def build_ir_cert_p2483_preview():
    return deepcopy(_build_cached())


def prepare_pack_2484_deployment_boundary():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2484",
