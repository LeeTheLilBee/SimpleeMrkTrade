...
from tower.tower_ir_cert_p2599 import tower_ir_cert_p2599


def test_tower_ir_cert_p2599_ob_real_surface_route_map():
    cert = tower_ir_cert_p2599()

    assert cert["pack"] == 2599
    assert cert["title"] == "Owner Console route mapping"
