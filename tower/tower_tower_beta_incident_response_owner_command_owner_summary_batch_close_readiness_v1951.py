"""
SEARCHABLE LABEL:
TOWER_PACK_1951_TOWER_BETA_INCIDENT_RESPONSE_OWNER_COMMAND_OWNER_SUMMARY_BATCH_CLOSE_READINESS
"""
...
PACK_ID = "1951"
PACK_NUMBER = 1951
PACK_NAME = "Tower Beta Incident Response Owner Command Owner Summary Batch Close Readiness Preview"
ENDPOINT = "/tower/tower-beta-incident-response-owner-command-owner-summary-batch-close-readiness-v1951.json"
...
def _source_payload():
    return deepcopy({'pack': '1950', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-command-owner-summary-readiness-bridge-v1950.json', 'safe_to_continue_to_pack_1951': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_command_owner_summary_batch_close_readiness_"
                "1951_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_1951") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_command_owner_summary_batch_close_readiness_ready": ready,
    ...
    return {
        ...
        "tower_beta_incident_response_owner_command_owner_summary_batch_close_readiness_summary": summary,
        "safe_to_continue_to_pack_1952": ready,
    }


def build_tower_beta_incident_response_owner_command_owner_summary_batch_close_readiness_preview():
    return deepcopy(_build_cached())


def build_pack_1951_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_1952": payload[
            "safe_to_continue_to_pack_1952"
        ],
    }


def prepare_pack_1952_tower_beta_incident_response_owner_command_closeout_index():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Command Closeout Index Preview",
        "source_pack": PACK_ID,
