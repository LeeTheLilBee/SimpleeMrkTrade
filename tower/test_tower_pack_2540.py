from tower.tower_ir_cert_p2540 import (
    build_ir_cert_p2540_preview,
)


def test_pack_2540_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2540_preview()

    assert payload["pack"] == "2540"
    assert payload["pack_name"] == 'Door Evidence Drawers'
    ...
    assert payload["door_evidence_drawers_ready"] is True
