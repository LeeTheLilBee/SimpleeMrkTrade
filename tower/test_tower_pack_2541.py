from tower.tower_ir_cert_p2541 import (
    build_ir_cert_p2541_preview,
)


def test_pack_2541_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2541_preview()

    assert payload["pack"] == "2541"
    assert payload["pack_name"] == 'Registry Cert Routes'
    ...
    assert payload["registry_cert_routes_ready"] is True
