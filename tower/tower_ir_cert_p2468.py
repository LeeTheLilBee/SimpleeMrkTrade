"""
Pack 2468 — Controlled Restore Preview.
"""
...
PACK_ID = "2468"
ENDPOINT = "/tower/ir-cert-v2468.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Controlled Restore Preview',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "controlled_restore_ready": True,
        "backup_directory_environment_key": (
            BACKUP_DIRECTORY_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2469",
        "safe_to_continue_to_pack_2469": True,
    }


def build_ir_cert_p2468_preview():
    return deepcopy(_build_cached())


def prepare_pack_2469_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2469",
