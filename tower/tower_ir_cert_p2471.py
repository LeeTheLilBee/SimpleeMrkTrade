"""
Pack 2471 — Corruption Detection and Recovery.
"""
...
PACK_ID = "2471"
ENDPOINT = "/tower/ir-cert-v2471.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Corruption Detection and Recovery',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "corruption_recovery_ready": True,
        "backup_directory_environment_key": (
            BACKUP_DIRECTORY_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2472",
        "safe_to_continue_to_pack_2472": True,
    }


def build_ir_cert_p2471_preview():
    return deepcopy(_build_cached())


def prepare_pack_2472_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2472",
