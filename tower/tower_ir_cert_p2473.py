"""
Pack 2473 — Hosted Runtime Environment Gate.
"""
...
PACK_ID = "2473"
ENDPOINT = "/tower/ir-cert-v2473.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Hosted Runtime Environment Gate',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "hosted_runtime_gate_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2474",
        "safe_to_continue_to_pack_2474": True,
    }


def build_ir_cert_p2473_preview():
    return deepcopy(_build_cached())


def prepare_pack_2474_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2474",
