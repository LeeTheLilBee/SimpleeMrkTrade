...
from tower.tower_ir_cert_p2589 import tower_ir_cert_p2589


def test_tower_ir_cert_p2589_walkthrough_closeout():
    cert = tower_ir_cert_p2589()

    assert cert["pack"] == 2589
    assert cert["title"] == "Beta scope reminder"
