"""
Pack 2512 — Human Login-to-OB Checkpoint.
"""
...
PACK_ID = "2512"
ENDPOINT = "/tower/ir-cert-v2512.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Human Login-to-OB Checkpoint',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "human_login_ob_checkpoint_ready": True,
        ...
        "public_links": False,
        "next_pack": "2513",
        "safe_to_continue_to_pack_2513": True,
    }


def build_ir_cert_p2512_preview():
