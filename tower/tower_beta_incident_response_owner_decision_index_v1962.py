"""
SEARCHABLE LABEL:
TOWER_PACK_1962_INCIDENT_RESPONSE_OWNER_DECISION_INDEX
...
PACK_NAME = (
    ...
    "Owner Decision Index Preview"
)
ENDPOINT = "/tower/beta-incident-response-owner-decision-index-v1962.json"
...
TOWER_SUBLAYER = (
    "Incident Response Owner Decision Index"
)
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": f"pack_1962_category_{index:03d}",
    ...
    for index, item in enumerate(
        ...
        rows.append({
            "row_id": f"pack_1962_item_{index:03d}",
    ...
    for index, action in enumerate(
        ...
        rows.append({
            "row_id": f"pack_1962_blocked_{index:03d}",
    ...
    return {
        ...
        "tower_pack_1962_summary": summary,
        "safe_to_continue_to_pack_1963": ready,
    }
...
def build_pack_1962_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_1963": payload[
            "safe_to_continue_to_pack_1963"
        ],
    }


def prepare_pack_1963_tower_beta_incident_response_owner_decision_index():
    return {
        "ready": True,
        "next_pack": "1963",
        "source_pack": "1962",
