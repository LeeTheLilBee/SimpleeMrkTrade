"""
Pack 2459 — Run Detail and Evidence View.
"""
...
PACK_ID = "2459"
ENDPOINT = "/tower/ir-cert-v2459.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Run Detail and Evidence View',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "run_detail_evidence_ready": True,
        "database_environment_key": (
            DATABASE_ENVIRONMENT_KEY
        ),
        ...
        "contract_only": True,
        "next_pack": "2460",
        "safe_to_continue_to_pack_2460": True,
    }


def build_ir_cert_p2459_preview():
    return deepcopy(_build_cached())


def prepare_pack_2460_guided_run_persistence():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2460",
