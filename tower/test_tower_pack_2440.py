...
def test_pack_2440_real_surface_contract():
    payload = build_ir_cert_p2440_preview()

    assert payload["status"] == "ready"
    assert payload["readiness"] == 100
    assert payload["review_center_real_surface_ready"] is True
