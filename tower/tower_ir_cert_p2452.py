"""
Pack 2452 — Full Real-Surface Run Rehearsal.
"""
...
PACK_ID = "2452"
ENDPOINT = "/tower/ir-cert-v2452.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Full Real-Surface Run Rehearsal',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "full_real_surface_rehearsal_ready": True,
        "guided_run_route": (
        ...
        "writes_state": False,
        "next_pack": "2453",
        "safe_to_continue_to_pack_2453": True,
    }


def build_ir_cert_p2452_preview():
    return deepcopy(_build_cached())


def prepare_pack_2453_guided_ob_run():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2453",
