...
from tower.tower_ir_cert_p2563 import tower_ir_cert_p2563


def test_tower_ir_cert_p2563_owner_beta_route_gate():
    cert = tower_ir_cert_p2563()

    assert cert["pack"] == 2563
    assert cert["title"] == "Owner-beta route boundary contract"
