from tower.tower_ir_cert_p2546 import (
    build_ir_cert_p2546_preview,
)


def test_pack_2546_tower_ob_handoff_contract():
    payload = build_ir_cert_p2546_preview()

    assert payload["pack"] == "2546"
    assert payload["pack_name"] == 'OB to Tower Return Continuity Contract'
    ...
    assert payload["ob_to_tower_return_continuity_contract_ready"] is True
    assert payload[
