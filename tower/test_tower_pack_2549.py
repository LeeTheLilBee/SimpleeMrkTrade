from tower.tower_ir_cert_p2549 import (
    build_ir_cert_p2549_preview,
)


def test_pack_2549_tower_ob_handoff_contract():
    payload = build_ir_cert_p2549_preview()

    assert payload["pack"] == "2549"
    assert payload["pack_name"] == 'Dangerous Control Lock Verification'
    ...
    assert payload["dangerous_control_lock_verification_ready"] is True
    assert payload[
