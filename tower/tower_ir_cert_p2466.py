"""
Pack 2466 — Safe Backup Snapshot.
"""
...
PACK_ID = "2466"
ENDPOINT = "/tower/ir-cert-v2466.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Safe Backup Snapshot',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "safe_backup_snapshot_ready": True,
        "backup_directory_environment_key": (
            BACKUP_DIRECTORY_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2467",
        "safe_to_continue_to_pack_2467": True,
    }


def build_ir_cert_p2466_preview():
    return deepcopy(_build_cached())


def prepare_pack_2467_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2467",
