from tower.tower_ir_cert_p2528 import (
    build_ir_cert_p2528_preview,
)


def test_pack_2528_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2528_preview()

    assert payload["pack"] == "2528"
    assert payload["pack_name"] == 'Security / Session Summary'
    ...
    assert payload["security_session_summary_ready"] is True
