"""
Pack 2446 — Walkthrough Resume Contract.
"""
...
PACK_ID = "2446"
ENDPOINT = "/tower/ir-cert-v2446.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Walkthrough Resume Contract',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "walkthrough_resume_ready": True,
        "guided_run_route": (
        ...
        "writes_state": False,
        "next_pack": "2447",
        "safe_to_continue_to_pack_2447": True,
    }


def build_ir_cert_p2446_preview():
    return deepcopy(_build_cached())


def prepare_pack_2447_guided_ob_run():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2447",
