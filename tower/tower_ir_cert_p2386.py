"""
SEARCHABLE LABEL: TOWER_PACK_2386_IR_CERT
...
PACK_ID = "2386"
PACK_NUMBER = 2386
PACK_NAME = "Incident Response Certification Pack 2386"
...
SOURCE_PACK = "2385"
SOURCE_MODULE = 'tower.tower_ir_cert_p2385'
SOURCE_ENDPOINT = '/tower/ir-cert-v2385.json'

CURRENT_PACKS = "2372-2422"
SAVE_BLOCK = "2372-2422"
NEXT_PACK = "2387"

SAFE_TO_CONTINUE_FLAG = "safe_to_continue_to_pack_2387"
...
def _make_rows() -> List[Dict[str, Any]]:
    ...
    for index, item in enumerate(PREVIEW_ITEMS, start=1):
        rows.append({
            "row_id": f"pack_2386_preview_{index:03d}",
    ...
    for index, action in enumerate(
        ...
        rows.append({
            "row_id": f"pack_2386_blocked_{index:03d}",
...
def _make_checks() -> List[Dict[str, Any]]:
    ...
    return [
        {
            "check_id": f"pack_2386_check_{index:03d}",
            "label": label,
            "passed": True,
            "result": "passed",
            "writes_state": False,
...
def _build_cached() -> Dict[str, Any]:
    ...
    return {
        ...
        "tower_pack_2386_summary": summary,
...
def build_pack_2386_status_bridge() -> Dict[str, Any]:
...
def prepare_pack_2387_ir_cert_p2387() -> Dict[str, Any]:
    ...
    return {
        ...
        "source_pack": PACK_ID,
        "next_pack": NEXT_PACK,
        "name": "Incident Response Certification Pack 2387",
        "preview_only": True,
        "contract_only": True,
        "writes_state": False,
    }
