"""
Pack 2496 — Activation Scope Freeze.
"""
...
PACK_ID = "2496"
ENDPOINT = "/tower/ir-cert-v2496.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Activation Scope Freeze',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "activation_scope_freeze_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2497",
        "safe_to_continue_to_pack_2497": True,
    }


def build_ir_cert_p2496_preview():
    return deepcopy(_build_cached())


def prepare_pack_2497_activation_approval():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2497",
