...
from tower.tower_ir_cert_p2580 import tower_ir_cert_p2580


def test_tower_ir_cert_p2580_issue_intake():
    cert = tower_ir_cert_p2580()

    assert cert["pack"] == 2580
    assert cert["title"] == "Market Map feedback classification"
