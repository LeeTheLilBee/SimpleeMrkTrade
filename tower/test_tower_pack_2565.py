...
from tower.tower_ir_cert_p2565 import tower_ir_cert_p2565


def test_tower_ir_cert_p2565_owner_beta_route_gate():
    cert = tower_ir_cert_p2565()

    assert cert["pack"] == 2565
    assert cert["title"] == "Anonymous denial for owner-beta JSON"
