"""
SEARCHABLE LABEL:
TOWER_PACK_2002_TOWER_BETA_INCIDENT_RESPONSE_OWNER_DECISION_OWNER_SUMMARY_BATCH_CLOSE_READINESS
...
PACK_ID = "2002"
PACK_NUMBER = 2002
PACK_NAME = "Tower Beta Incident Response Owner Decision Owner Summary Batch Close Readiness Preview"
ENDPOINT = "/tower/tower-beta-incident-response-owner-decision-owner-summary-batch-close-readiness-v2002.json"
...
def _source_payload():
    return deepcopy({'pack': '2001', 'status': 'ready', 'readiness': 100, 'endpoint': '/tower/tower-beta-incident-response-owner-decision-owner-summary-readiness-bridge-v2001.json', 'safe_to_continue_to_pack_2002': True})
...
def _build_cached():
    ...
    for index, category in enumerate(
        ...
        rows.append({
            "row_id": (
                "tower_beta_incident_response_owner_decision_owner_summary_batch_close_readiness_"
                "2002_category_"
                + str(index).zfill(3)
            ),
    ...
    source_ready = all([
        ...
        source.get("safe_to_continue_to_pack_2002") is True,
    ])
    ...
    summary = {
        ...
        "tower_beta_incident_response_owner_decision_owner_summary_batch_close_readiness_ready": ready,
    ...
    return {
        ...
        "tower_beta_incident_response_owner_decision_owner_summary_batch_close_readiness_summary": summary,
        "safe_to_continue_to_pack_2003": ready,
    }


def build_tower_beta_incident_response_owner_decision_owner_summary_batch_close_readiness_preview():
    return deepcopy(_build_cached())


def build_pack_2002_status_bridge():
    ...
    return {
        ...
        "safe_to_continue_to_pack_2003": payload[
            "safe_to_continue_to_pack_2003"
        ],
    }


def prepare_pack_2003_tower_beta_incident_response_owner_decision_closeout_index():
    return {
        "ready": True,
        "next_pack": NEXT_PACK,
        "name": "Tower Beta Incident Response Owner Decision Closeout Index Preview",
        "source_pack": PACK_ID,
