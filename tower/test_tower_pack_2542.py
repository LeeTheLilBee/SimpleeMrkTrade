from tower.tower_ir_cert_p2542 import (
    build_ir_cert_p2542_preview,
)


def test_pack_2542_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2542_preview()
