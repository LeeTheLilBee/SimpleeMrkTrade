from tower.tower_ir_cert_p2526 import (
    build_ir_cert_p2526_preview,
)


def test_pack_2526_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2526_preview()

    assert payload["pack"] == "2526"
    assert payload["pack_name"] == 'Step-up Freshness Status Panel'
    ...
    assert payload["step_up_freshness_status_panel_ready"] is True
