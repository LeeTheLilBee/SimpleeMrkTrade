...
PACK_ID = "2520"
ENDPOINT = "/tower/ir-cert-v2520.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'Quick Launch Panel',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "quick_launch_panel_ready": True,
        ...
        "contract": contract,
        "next_pack": "2521",
        "safe_to_continue_to_pack_2521": True,
    }

    return payload


def build_ir_cert_p2520_preview():
