...
from tower.tower_ir_cert_p2585 import tower_ir_cert_p2585


def test_tower_ir_cert_p2585_walkthrough_closeout():
    cert = tower_ir_cert_p2585()

    assert cert["pack"] == 2585
    assert cert["title"] == "Hosted proof summary"
