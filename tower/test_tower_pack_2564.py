...
from tower.tower_ir_cert_p2564 import tower_ir_cert_p2564


def test_tower_ir_cert_p2564_owner_beta_route_gate():
    cert = tower_ir_cert_p2564()

    assert cert["pack"] == 2564
    assert cert["title"] == "Anonymous denial for owner-beta HTML"
