"""
Pack 2509 — Observatory Step-Up Gate.
"""
...
PACK_ID = "2509"
ENDPOINT = "/tower/ir-cert-v2509.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Observatory Step-Up Gate',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "observatory_step_up_gate_ready": True,
        ...
        "public_links": False,
        "next_pack": "2510",
        "safe_to_continue_to_pack_2510": True,
    }


def build_ir_cert_p2509_preview():
