...
from tower.tower_ir_cert_p2584 import tower_ir_cert_p2584


def test_tower_ir_cert_p2584_walkthrough_closeout():
    cert = tower_ir_cert_p2584()

    assert cert["pack"] == 2584
    assert cert["title"] == "Owner walkthrough checklist"
