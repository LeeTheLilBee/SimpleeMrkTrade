"""
Pack 2516 — Observatory Launch Door.
"""
...
PACK_ID = "2516"
ENDPOINT = "/tower/ir-cert-v2516.json"
...
def _build_cached() -> Dict[str, Any]:
    ...
    payload = {
        "pack": PACK_ID,
        "pack_name": 'Observatory Launch Door',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "observatory_launch_door_ready": True,
        ...
        "contract": contract,
        "next_pack": "2517",
        "safe_to_continue_to_pack_2517": True,
    }

    return payload


def build_ir_cert_p2516_preview():
