...
from tower.tower_ir_cert_p2596 import tower_ir_cert_p2596


def test_tower_ir_cert_p2596_ob_real_surface_route_map():
    cert = tower_ir_cert_p2596()

    assert cert["pack"] == 2596
    assert cert["title"] == "Dynamic Symbol Page route mapping"
