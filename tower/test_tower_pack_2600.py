...
from tower.tower_ir_cert_p2600 import tower_ir_cert_p2600


def test_tower_ir_cert_p2600_ob_real_surface_route_map():
    cert = tower_ir_cert_p2600()

    assert cert["pack"] == 2600
    assert cert["title"] == "Unmapped OB default-deny preservation"
