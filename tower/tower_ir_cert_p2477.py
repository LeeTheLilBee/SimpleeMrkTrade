"""
Pack 2477 — Controlled Restore Drill.
"""
...
PACK_ID = "2477"
ENDPOINT = "/tower/ir-cert-v2477.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Controlled Restore Drill',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "controlled_restore_drill_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2478",
        "safe_to_continue_to_pack_2478": True,
    }


def build_ir_cert_p2477_preview():
    return deepcopy(_build_cached())


def prepare_pack_2478_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2478",
