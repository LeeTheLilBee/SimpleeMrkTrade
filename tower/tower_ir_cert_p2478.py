"""
Pack 2478 — Retention Approval Queue.
"""
...
PACK_ID = "2478"
ENDPOINT = "/tower/ir-cert-v2478.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Retention Approval Queue',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "retention_approval_queue_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2479",
        "safe_to_continue_to_pack_2479": True,
    }


def build_ir_cert_p2478_preview():
    return deepcopy(_build_cached())


def prepare_pack_2479_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2479",
