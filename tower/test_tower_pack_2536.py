from tower.tower_ir_cert_p2536 import (
    build_ir_cert_p2536_preview,
)


def test_pack_2536_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2536_preview()

    assert payload["pack"] == "2536"
    assert payload["pack_name"] == 'Door Permission Boundary Model'
    ...
    assert payload["door_permission_boundary_model_ready"] is True
