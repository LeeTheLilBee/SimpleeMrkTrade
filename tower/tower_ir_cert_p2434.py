"""
Pack 2434 — Tower Walkthrough Entry Navigation Integration.
"""
...
PACK_ID = "2434"
ENDPOINT = "/tower/ir-cert-v2434.json"
TARGET_ROOM_ID = None
...
def _build_cached() -> Dict[str, Any]:
    ...
    return {
        "pack": PACK_ID,
        "pack_name": 'Tower Walkthrough Entry Navigation Integration',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "tower_entry_navigation_ready": True,
        ...
        "writes_state": False,
        "next_pack": "2435",
        "safe_to_continue_to_pack_2435": True,
    }


def build_ir_cert_p2434_preview():
    return deepcopy(_build_cached())


def prepare_pack_2435_ob_real_surface():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2435",
