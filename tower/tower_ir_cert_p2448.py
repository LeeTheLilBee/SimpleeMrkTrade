"""
Pack 2448 — Guided Next-Room Handoff.
"""
...
PACK_ID = "2448"
ENDPOINT = "/tower/ir-cert-v2448.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Guided Next-Room Handoff',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "guided_next_room_handoff_ready": True,
        "guided_run_route": (
        ...
        "writes_state": False,
        "next_pack": "2449",
        "safe_to_continue_to_pack_2449": True,
    }


def build_ir_cert_p2448_preview():
    return deepcopy(_build_cached())


def prepare_pack_2449_guided_ob_run():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2449",
