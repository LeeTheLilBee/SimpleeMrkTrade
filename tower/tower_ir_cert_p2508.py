"""
Pack 2508 — Observatory Permission Gate.
"""
...
PACK_ID = "2508"
ENDPOINT = "/tower/ir-cert-v2508.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Observatory Permission Gate',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "observatory_permission_gate_ready": True,
        ...
        "public_links": False,
        "next_pack": "2509",
        "safe_to_continue_to_pack_2509": True,
    }


def build_ir_cert_p2508_preview():
