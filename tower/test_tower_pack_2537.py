from tower.tower_ir_cert_p2537 import (
    build_ir_cert_p2537_preview,
)


def test_pack_2537_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2537_preview()

    assert payload["pack"] == "2537"
    assert payload["pack_name"] == 'Door Launch / Route Map'
    ...
    assert payload["door_launch_route_map_ready"] is True
