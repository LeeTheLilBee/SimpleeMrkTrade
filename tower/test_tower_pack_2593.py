...
from tower.tower_ir_cert_p2593 import tower_ir_cert_p2593


def test_tower_ir_cert_p2593_ob_real_surface_route_map():
    cert = tower_ir_cert_p2593()

    assert cert["pack"] == 2593
    assert cert["title"] == "Tower OB real-surface route contract"
