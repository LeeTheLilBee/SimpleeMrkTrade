...
from tower.tower_ir_cert_p2602 import tower_ir_cert_p2602


def test_tower_ir_cert_p2602_ob_real_surface_route_map():
    cert = tower_ir_cert_p2602()

    assert cert["pack"] == 2602
    assert cert["title"] == "Route integration repair cert"
