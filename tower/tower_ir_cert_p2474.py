"""
Pack 2474 — Persistence Startup Fail-Closed Contract.
"""
...
PACK_ID = "2474"
ENDPOINT = "/tower/ir-cert-v2474.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Persistence Startup Fail-Closed Contract',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "startup_fail_closed_ready": True,
        "hosted_mode_environment_key": (
            HOSTED_MODE_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2475",
        "safe_to_continue_to_pack_2475": True,
    }


def build_ir_cert_p2474_preview():
    return deepcopy(_build_cached())


def prepare_pack_2475_hosted_assurance():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2475",
