...
# Updated in Pack 159B-5:
# Pack 152-159 policy JSON endpoints are guarded in web/app.py by compatibility
...
def pack_156_patch_route_coverage_payload(payload):
    ...
    It only affects the known Pack 152-159 policy JSON endpoints.
    ...
    try:
            ...
            if isinstance(value, list):
                for item in value:
                    if isinstance(item, dict) and _is_policy_item(item):
                        ...
                        item["guard_source"] = "pack_159_policy_route_guard_wrapper"
        ...
        payload["pack_156_policy_route_guard_recognition"] = {
            ...
            "note": "Known Pack 152-159 policy JSON endpoints use compatibility wrapper guards in web/app.py.",
        }
