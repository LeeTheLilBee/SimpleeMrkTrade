...
from tower.tower_ir_cert_p2573 import tower_ir_cert_p2573


def test_tower_ir_cert_p2573_issue_intake():
    cert = tower_ir_cert_p2573()

    assert cert["pack"] == 2573
    assert cert["title"] == "Issue intake persistence contract"
