from tower.tower_ir_cert_p2534 import (
    build_ir_cert_p2534_preview,
)


def test_pack_2534_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2534_preview()

    assert payload["pack"] == "2534"
    assert payload["pack_name"] == 'Door Card Metadata Model'
    ...
    assert payload["door_card_metadata_model_ready"] is True
