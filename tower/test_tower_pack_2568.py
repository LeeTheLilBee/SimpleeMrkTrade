...
from tower.tower_ir_cert_p2568 import tower_ir_cert_p2568


def test_tower_ir_cert_p2568_owner_beta_route_gate():
    cert = tower_ir_cert_p2568()

    assert cert["pack"] == 2568
    assert cert["title"] == "Login redirect and 403-safe route behavior"
