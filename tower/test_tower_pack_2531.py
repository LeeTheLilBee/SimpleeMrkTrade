from tower.tower_ir_cert_p2531 import (
    build_ir_cert_p2531_preview,
)


def test_pack_2531_tower_owner_console_v1_contract():
    payload = build_ir_cert_p2531_preview()

    assert payload["pack"] == "2531"
    assert payload["pack_name"] == 'Owner Console Cert Routes'
    ...
    assert payload["owner_console_cert_routes_ready"] is True
