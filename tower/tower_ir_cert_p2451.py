"""
Pack 2451 — Walkthrough Reset and New-Run Contract.
"""
...
PACK_ID = "2451"
ENDPOINT = "/tower/ir-cert-v2451.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Walkthrough Reset and New-Run Contract',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "walkthrough_reset_ready": True,
        "guided_run_route": (
        ...
        "writes_state": False,
        "next_pack": "2452",
        "safe_to_continue_to_pack_2452": True,
    }


def build_ir_cert_p2451_preview():
    return deepcopy(_build_cached())


def prepare_pack_2452_guided_ob_run():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2452",
