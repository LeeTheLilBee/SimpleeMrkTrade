...
PACK_ID = "2460"
ENDPOINT = "/tower/ir-cert-v2460.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Lost-Session Resume',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "lost_session_resume_ready": True,
        "database_environment_key": (
            DATABASE_ENVIRONMENT_KEY
        ),
        ...
        "contract_only": True,
        "next_pack": "2461",
        "safe_to_continue_to_pack_2461": True,
    }


def build_ir_cert_p2460_preview():
    return deepcopy(_build_cached())


def prepare_pack_2461_guided_run_persistence():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2461",
