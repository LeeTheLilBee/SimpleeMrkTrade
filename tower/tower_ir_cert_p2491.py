"""
Pack 2491 — Hosted Activation Recommendation.
"""
...
PACK_ID = "2491"
ENDPOINT = "/tower/ir-cert-v2491.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Hosted Activation Recommendation',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "activation_recommendation_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2492",
        "safe_to_continue_to_pack_2492": True,
    }


def build_ir_cert_p2491_preview():
    return deepcopy(_build_cached())


def prepare_pack_2492_deployment_boundary():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2492",
