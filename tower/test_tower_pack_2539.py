from tower.tower_ir_cert_p2539 import (
    build_ir_cert_p2539_preview,
)


def test_pack_2539_tower_app_registry_v2_contract():
    payload = build_ir_cert_p2539_preview()

    assert payload["pack"] == "2539"
    assert payload["pack_name"] == 'Door Integration Readiness View'
    ...
    assert payload["door_integration_readiness_view_ready"] is True
