...
from tower.tower_ir_cert_p2595 import tower_ir_cert_p2595


def test_tower_ir_cert_p2595_ob_real_surface_route_map():
    cert = tower_ir_cert_p2595()

    assert cert["pack"] == 2595
    assert cert["title"] == "Market Map route mapping"
