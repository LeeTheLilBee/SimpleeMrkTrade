...
from tower.tower_ir_cert_p2582 import tower_ir_cert_p2582


def test_tower_ir_cert_p2582_issue_intake():
    cert = tower_ir_cert_p2582()

    assert cert["pack"] == 2582
    assert cert["title"] == "Route/API integration safety cert"
