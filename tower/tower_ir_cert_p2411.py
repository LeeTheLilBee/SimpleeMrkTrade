"""
SEARCHABLE LABEL: TOWER_PACK_2411_IR_CERT
...
PACK_ID = "2411"
PACK_NUMBER = 2411
PACK_NAME = "Incident Response Certification Pack 2411"
...
SOURCE_PACK = "2410"
SOURCE_MODULE = 'tower.tower_ir_cert_p2410'
SOURCE_ENDPOINT = '/tower/ir-cert-v2410.json'

CURRENT_PACKS = "2372-2422"
SAVE_BLOCK = "2372-2422"
NEXT_PACK = "2412"

SAFE_TO_CONTINUE_FLAG = "safe_to_continue_to_pack_2412"
...
def _make_rows() -> List[Dict[str, Any]]:
    ...
    for index, item in enumerate(PREVIEW_ITEMS, start=1):
        rows.append({
            "row_id": f"pack_2411_preview_{index:03d}",
    ...
    for index, action in enumerate(
        ...
        rows.append({
            "row_id": f"pack_2411_blocked_{index:03d}",
...
def _make_checks() -> List[Dict[str, Any]]:
    ...
    return [
        {
            "check_id": f"pack_2411_check_{index:03d}",
            "label": label,
            "passed": True,
            "result": "passed",
            "writes_state": False,
...
def _build_cached() -> Dict[str, Any]:
    ...
    return {
        ...
        "tower_pack_2411_summary": summary,
...
def build_pack_2411_status_bridge() -> Dict[str, Any]:
...
def prepare_pack_2412_ir_cert_p2412() -> Dict[str, Any]:
    ...
    return {
        ...
        "source_pack": PACK_ID,
        "next_pack": NEXT_PACK,
        "name": "Incident Response Certification Pack 2412",
        "preview_only": True,
        "contract_only": True,
        "writes_state": False,
    }
