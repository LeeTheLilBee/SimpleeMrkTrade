"""
Pack 2472 — Hosted Persistence Operations Readiness.
"""
...
PACK_ID = "2472"
ENDPOINT = "/tower/ir-cert-v2472.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Hosted Persistence Operations Readiness',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "operations_readiness_ready": True,
        "backup_directory_environment_key": (
            BACKUP_DIRECTORY_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2473",
        "safe_to_continue_to_pack_2473": True,
    }


def build_ir_cert_p2472_preview():
    return deepcopy(_build_cached())


def prepare_pack_2473_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2473",
