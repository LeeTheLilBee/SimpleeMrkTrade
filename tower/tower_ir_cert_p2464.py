"""
Pack 2464 — Schema Migration and Version Gate.
"""
...
PACK_ID = "2464"
ENDPOINT = "/tower/ir-cert-v2464.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Schema Migration and Version Gate',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "schema_version_gate_ready": True,
        "backup_directory_environment_key": (
            BACKUP_DIRECTORY_ENVIRONMENT_KEY
        ),
        ...
        "preview_only": True,
        "next_pack": "2465",
        "safe_to_continue_to_pack_2465": True,
    }


def build_ir_cert_p2464_preview():
    return deepcopy(_build_cached())


def prepare_pack_2465_persistence_operations():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2465",
