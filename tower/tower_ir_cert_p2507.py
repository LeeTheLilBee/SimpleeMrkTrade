"""
Pack 2507 — Observatory Launch Card.
"""
...
PACK_ID = "2507"
ENDPOINT = "/tower/ir-cert-v2507.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Observatory Launch Card',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "observatory_launch_card_ready": True,
        ...
        "public_links": False,
        "next_pack": "2508",
        "safe_to_continue_to_pack_2508": True,
    }


def build_ir_cert_p2507_preview():
