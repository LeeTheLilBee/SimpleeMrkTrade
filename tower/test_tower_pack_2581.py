...
from tower.tower_ir_cert_p2581 import tower_ir_cert_p2581


def test_tower_ir_cert_p2581_issue_intake():
    cert = tower_ir_cert_p2581()

    assert cert["pack"] == 2581
    assert cert["title"] == "Owner decision receipt surface"
