...
PACK_ID = "2506"
ENDPOINT = "/tower/ir-cert-v2506.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Tower Access Home',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "tower_access_home_ready": True,
        ...
        "public_links": False,
        "next_pack": "2507",
        "safe_to_continue_to_pack_2507": True,
    }


def build_ir_cert_p2506_preview():
