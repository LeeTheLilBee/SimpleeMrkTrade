"""
Pack 2498 — Rollback Readiness Receipt.
"""
...
PACK_ID = "2498"
ENDPOINT = "/tower/ir-cert-v2498.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Rollback Readiness Receipt',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "rollback_readiness_receipt_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2499",
        "safe_to_continue_to_pack_2499": True,
    }


def build_ir_cert_p2498_preview():
    return deepcopy(_build_cached())


def prepare_pack_2499_activation_approval():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2499",
