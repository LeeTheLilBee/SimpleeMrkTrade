"""
Pack 2495 — Approval Challenge Receipt.
"""
...
PACK_ID = "2495"
ENDPOINT = "/tower/ir-cert-v2495.json"
...
def _build_cached() -> Dict[str, Any]:
    return {
        "pack": PACK_ID,
        "pack_name": 'Approval Challenge Receipt',
        "status": "ready",
        "readiness": 100,
        "endpoint": ENDPOINT,
        "approval_challenge_receipt_ready": True,
        ...
        "preview_only": True,
        "next_pack": "2496",
        "safe_to_continue_to_pack_2496": True,
    }


def build_ir_cert_p2495_preview():
    return deepcopy(_build_cached())


def prepare_pack_2496_activation_approval():
    return {
        "ready": True,
        "source_pack": PACK_ID,
        "next_pack": "2496",
